...
| Target                                       | Expression                                                   |
| -------------------------------------------- | ------------------------------------------------------------ |
| Customized S-box                             |$\Delta_{0,1} = k_1 \oplus k_0 = p_{r,0} \oplus p_{s,1}$ <br/>$\Delta_{0,2} = k_2 \oplus k_0 = p_{r,0} \oplus p_{t,1}$ <br/>$\vdots$ <br/>$\Delta_{0,15} = k_{15} \oplus k_0 = p_{r,0} \oplus p_{u,15}$|
