...
#define AES_keyExpSize 176 // Expanded key size for AES-128
#define Nb 4
#define Nk 4  // The number of 32 bit words in a key (AES-128)
#define Nr 10 // The number of rounds in AES-128
static uint8_t SboxMasked[256];
static uint8_t rSboxMasked[256];
static uint8_t mask[16];
static uint8_t zero[16];
static uint8_t mask_shiftrow[16];
static uint8_t mask_col[16];
static uint8_t mask_in[16];
static uint8_t mask_out[16];
...
void addRoundKey2 (u8 state[16], u8 roundKey[16],u8 mask_in[16]);
